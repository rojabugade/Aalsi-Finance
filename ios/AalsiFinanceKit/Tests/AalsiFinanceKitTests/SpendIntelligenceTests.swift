...
@Suite struct SpendIntelligenceTests {
    ...
    private func recurringSeries(
        ...
        let json = #"{"id":"\#(id)","name":"\#(name)","amount":"\#(amount)","currency":"USD","cadence":"\#(cadence)","type":"\#(type)","status":"\#(status)","next_due_date":"2026-08-10","merchant_name":"\#(merchant)","category_name":"Entertainment"}"#
